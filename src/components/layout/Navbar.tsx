...
import { ChevronRight, Cpu, Settings, Maximize, FileText, ArrowRight, Video, Target, Camera, Database, Shield, Zap, Crosshair, ChevronDown, Menu, X, Activity, Sun, MapPin, CreditCard, Banknote } from "lucide-react";
