...
const industriesDb: Record<string, any> = {
  ...
  "oil-gas": {
    ...
    img: "/images/industries/oil-day.jpg",
    threatLevel: "CRITICAL",
    telemetryStats: [
        ...
        <section className="py-24 bg-[#020406] border-t border-brand-teal/20 shadow-[inset_0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="relative w-full aspect-video rounded-sm overflow-hidden group border border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.8)] cursor-crosshair">
              ...
              <img src="/images/industries/oil-day.jpg" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" alt="Daytime Setup" />
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-[1s] ease-in z-10">
                <img src="/images/industries/oil-night.jpg" className="w-full h-full object-cover scale-105" alt="Nighttime Setup" />
                
                {/* Optional Physical Hardware Glow Enhancements */}
                <div className="absolute top-[15%] right-[25%] -translate-y-1/2 w-40 h-40 bg-white blur-[120px] opacity-0 group-hover:opacity-40 transition-opacity duration-[2s] pointer-events-none" />
